            ...
            <div className='flex flex-row flex-wrap gap-3'>
              {
                arrayOfFilters.map(el => (
                  <p
                    className='flex overflow-hidden gap-2 items-center pt-0.5 pl-3 font-bold text-teal-600 bg-teal-50 rounded-md'
                    key={el}
                  >
                    {el}
                    <img
                      className='p-2 bg-teal-600 hover:bg-neutral-800 cursor-pointer'
                      src={'icon-remove.svg'}
                      alt='cross'
